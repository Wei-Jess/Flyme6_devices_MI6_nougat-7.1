...
.method public constructor <init>(Landroid/content/Context;Lcom/qti/dpm/DpmService;)V
    ...
    const-string/jumbo v1, "DpmNsrm constructor"
...
.method private setPolicyConfigUpdateBusy(IZ)V
    ...
    const-string/jumbo v2, "isNsrmConfigUpdateBusy: "
...
.method private updateNsrmConfig(Ljava/lang/String;)I
    ...
    const-string/jumbo v2, "updateNsrmConfig"
    ...
    const-string/jumbo v2, "Updating NSRM Config"
    ...
    const-string/jumbo v2, "nsrmConfigParser object is null"
    ...
    const-string/jumbo v2, "nsrmConfigRefresh failed"
    ...
    const-string/jumbo v2, "nsrmConfigRefresh success"
...
.method public getNSRMEnabled()I
    ...
    const-string/jumbo v1, "getNSRMEnabled()"
...
.method public getPolicyVersion(I)I
    ...
    const-string/jumbo v2, "Invalid PolicyType: "
...
.method public handleFeatureStatusSetResponse(Landroid/os/Parcel;)V
    ...
    .line 200
    .local v0, "error":I
    const-string/jumbo v3, "DPM:NSRM"

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v5, "handleFeatureStatusSetResponse(): feature status: "
...
.method public handleNsrmRefreshResponse(Landroid/os/Parcel;)V
    ...
    const-string/jumbo v3, "handleNsrmrefreshResponse called"
...
.method public handleUpdateWwanNetworkState(I)V
    .locals 1
    ...
    invoke-virtual {v0, p1}, Lcom/qti/dpm/DpmNsrmBackgroundEventHdlr;->sendWwanConnectivityState(I)V
...
.method public nsrmPostInit()V
    ...
    const-string/jumbo v1, "nsrmPostInit"
    ...
    const-string/jumbo v1, "nsrmPostInit: nsrmConfigRefresh"
...
.method public setNSRMEnabled(I)I
    ...
    const-string/jumbo v2, "setNSRMEnabled() nsrmSetType "
    ...
    :cond_0
    :try_start_1
    iget v0, p0, Lcom/qti/dpm/DpmNsrm;->mNSRMFeatureRequestedState:I
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-virtual {v0, v2, v1}, Lcom/qti/dpm/DpmService;->requestFeatureSettingsChange(II)Z
    :try_end_2
...
.method public updatePolicy(ILjava/lang/String;)I
    ...
    const-string/jumbo v3, "Path length too long"
    ...
    .line 92
    .local v1, "uid":I
    const-string/jumbo v2, "/system/etc/dpm/"
    ...
    .line 93
    const-string/jumbo v2, "/data/dpm/"
    ...
    const-string/jumbo v3, "This path is not allowed to access"
    ...
    const-string/jumbo v4, "Invalid PolicyType: "
    ...
    const-string/jumbo v3, "File size not supported"
